...
//             if (pointI == 11348)
//             {
//                 Pout << pointProcFaces[pointI] << endl;
//             } 
//         }
    }
...
leastSquaresVolPointInterpolation::~leastSquaresVolPointInterpolation()
{
    Info << "~leastSquaresVolPointInterpolation "  << mesh().name() << endl;
...
{
    Info << "leastSquaresVolPointInterpolation::movePoints() " << mesh().name() << endl;
...
//     deleteDemandDrivenData(pointNgbProcBndFaceCentresPtr_);
//     Pout << "leastSquaresVolPointInterpolation::updateMesh - done" << endl;
